...
import { ArrowRight, CheckCircle, Award, Users, Calendar, BarChart3, MessageSquare, Target } from "lucide-react"
        ...
        <div className="max-w-7xl mx-auto text-center">
          <div className="max-w-4xl mx-auto">
            ...
            <p className="text-xl text-muted-foreground mb-8 leading-relaxed">
              From basic profile optimization to complete LinkedIn domination, we have the perfect plan for your business goals.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8">
        <div className="max-w-7xl mx-auto">
          <div className="grid lg:grid-cols-3 gap-8">
            ...
            <Card className="border-border hover:shadow-lg transition-shadow relative">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-lg">
                  Perfect for entrepreneurs getting started on LinkedIn
                </CardDescription>
                <div className="mt-6">
              ...
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  <li className="flex items-start space-x-3">
                    ...
                    <span className="text-muted-foreground">Complete Profile Optimization</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">3 Posts per Week</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">Daily Engagement (Comments & Likes)</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">Weekly Connection Requests (50)</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
            ...
            {/* Professional Plan */}
            <Card className="border-border hover:shadow-lg transition-shadow relative border-primary">
              <CardHeader className="text-center">
                <div className="mb-4">
                ...
                <CardDescription className="text-lg">
                  For growing businesses serious about LinkedIn growth
                </CardDescription>
                <div className="mt-6">
              ...
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">5 Posts per Week</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">Advanced Content Strategy</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                  ...
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">Weekly Connection Requests (100)</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">Bi-weekly Strategy Calls</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
            ...
            <Card className="border-border hover:shadow-lg transition-shadow relative">
              <CardHeader className="text-center">
                ...
                <CardDescription className="text-lg">
                  Complete LinkedIn domination for established businesses
                </CardDescription>
                <div className="mt-6">
                  <span className="text-4xl font-bold text-foreground">₹45,000</span>
                  <span className="text-muted-foreground">/month</span>
                </div>
              </CardHeader>
              <CardContent className="space-y-4">
                <ul className="space-y-3">
                  ...
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">7 Posts per Week</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">Viral Content Strategy</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">Advanced Lead Generation</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">Weekly Connection Requests (200)</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
                    <span className="text-muted-foreground">Weekly Strategy Calls</span>
                  </li>
                  <li className="flex items-start space-x-3">
                    <CheckCircle className="w-5 h-5 text-green-500 mt-0.5" />
          ...
          <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
            <Card className="border-border hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Complete profile makeover with professional design
                </CardDescription>
              </CardHeader>
              <CardContent>
            ...
            <Card className="border-border hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Engaging posts that drive engagement and leads
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
            ...
            <Card className="border-border hover:shadow-lg transition-shadow">
              <CardHeader>
                ...
                <CardDescription>
                  Data-driven insights and expert support
                </CardDescription>
              </CardHeader>
              <CardContent>
                <ul className="space-y-2 text-sm">
        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="space-y-8">
            <Card className="border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Yes, you can modify your plan at any time. Changes will be reflected in your next billing cycle. We recommend discussing changes with your account manager to ensure smooth transition.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Our onboarding includes initial strategy consultation, account setup, content planning, and training on our processes. You'll have a dedicated account manager throughout the process.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Absolutely! For teams and larger organizations, we offer custom enterprise packages with multiple profiles, team training, and dedicated account management. Contact us for a custom quote.
                </p>
              </CardContent>
            </Card>
            ...
            <Card className="border-border">
              ...
              <CardContent>
                <p className="text-muted-foreground">
                  Most clients see increased engagement within 2-3 weeks and significant profile growth within 30-60 days. Results vary based on your industry, current profile status, and chosen plan.
                </p>
              </CardContent>
            </Card>
          </div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          <Card className="border-border bg-background/80 backdrop-blur-sm p-8">
            <CardContent className="space-y-6">
              ...
              <p className="text-xl text-muted-foreground">
                Choose the perfect plan for your business and start growing your LinkedIn presence today.
              </p>
