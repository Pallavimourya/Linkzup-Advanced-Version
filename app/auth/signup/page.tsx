...
export default function SignUpPage() {
  ...
  const handleSocialSignUp = async (provider: "linkedin" | "google") => {
    console.log(`Starting ${provider} sign-up process...`)
    setIsLoading(true)
    try {
      if (provider === "linkedin") {
        console.log("[v0] Starting LinkedIn OAuth flow for signup")
        ...
        // Use the simplest approach - let NextAuth handle everything
      ...
      toast({
        title: "Error",
        description: `Something went wrong with ${provider} sign-up: ${error instanceof Error ? error.message : "Unknown error"}`,
        variant: "destructive",
      })
